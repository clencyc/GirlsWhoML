  ...
  return (
    <header className="absolute w-[1440px] h-[156px] left-0 top-0 z-50">
      ...
      >
        ...
        {/* Frame 155 - Logo */}
        <a href="/" className="flex flex-row items-center p-0 gap-[8px] w-[183px] h-[32px] order-0 transition-all duration-300 ease-out group">
        ...
        <span className="w-[143px] h-[24px] font-alata font-normal text-[40px] leading-[20px] tracking-[-0.05em] text-[#261033] order-1 transition-all duration-300 ease-out group">harangè</span>
      </a>

        {/* Frame 50 - About Us */}
    <a href="/about-us" className="flex flex-row items-center p-0 gap-[12px] order-2 transition-all duration-300 ease-out hover:text-[#261033] group">
      <span className="font-['Inter'] text-[20px] leading-[24px] tracking-[-0.02em] capitalize text-[#3A3A3A] whitespace-nowrap transition-all duration-300 ease-out group-hover:text-[#261033] group-hover:font-bold" style={{fontWeight: 500}}>About Us</span>
        ...
        <a href="/mosaic-of-voices" className="flex flex-row items-center p-0 gap-[12px] order-3 transition-all duration-300 ease-out hover:text-[#261033] group">
       ...
       <a href="/contact" className="box-border flex flex-row justify-center items-center p-[16px_20px] gap-[8px] bg-[#FFFFFF] border border-[rgba(0,0,0,0.1)] rounded-[100px] order-4 transition-all duration-300 ease-out hover:bg-[#F5F5F5] hover:shadow-lg active:scale-95 group">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="order-0 transition-all duration-300 ease-out group-hover:fill-[#FF6B6B]">
